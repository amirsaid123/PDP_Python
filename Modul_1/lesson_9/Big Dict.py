...
# for user in users:
#     if user["phone"].startswith("+81") or user["phone"].startswith("-81"):
...
#     if address.get("stateCode") in ["MS", "WI"]:
#         print(user["firstName"] + " " + user["lastName"])
...
#     if user["role"] == "admin":
#         print(user["firstName"] + " " + user["lastName"])
#         print("Card number:", user["bank"]["cardNumber"])
#         print()

# for user in users:
#     if user["address"]["state"] == "Mississippi" or user["address"]["state"] == "Wisconsin":
#         print(user["firstName"] + " " + user["lastName"])
#         for adr, value in user["address"].items():
#             print(f"{adr}: {value}")
...
#         print(user["firstName"] + " " + user["lastName"])
#         print("Weight: " + str(user["weight"]))
#         print()
#         summa += user["weight"]
#         num += 1
# print("Average weight: " + str(round((summa / num), 2)))
...
for user in users:
    if user["company"]["title"] == "Sales Manager":
        print(user["firstName"] + " " + user["lastName"])
        print("State:", user["address"]["state"])
        print("Code:", user["address"]["stateCode"])
        print("Postal:", user["address"]["postalCode"])
        print()
