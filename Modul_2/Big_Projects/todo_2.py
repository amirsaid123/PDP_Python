...
class UI:
    ...
    def categories(self):
        ...
        match key:
            case "1":
                ...
                found_categories = [cat for cat in categories if cat.lower().startswith(search_value)]
                if found_categories:
    ...
    def search_title(self):
        search_value = input("Enter a search term: ")
        found_todos = [to for to in todos if search_value.lower() in to.title.lower() or search_value.lower() in to.description.lower()]
        if found_todos:
            print("Found todos")
            for i, todo in enumerate(found_todos, 1):
                print(todo.display())
        else:
    ...
    def update_todo(self):
        ...
        print("0.Back <-")
        todo_index = int(input("Choose a todo to update:"))
        if todo_index == 0:
            self.todo()
